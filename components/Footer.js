    ...
    <footer className="bg-primary text-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-6">
        ...
        <div className="mb-6 md:mb-0 w-full md:w-1/4">
          <h3 className="text-lg font-bold mb-2">Caroline Cleaning Service</h3>
          ...
          <div className="flex items-center mb-2">
            ...
            <span className="text-sm">info@CarolineCleaningService.com</span>
          </div>
          <div className="flex items-center mb-2">
      ...
      <div className="border-t border-lightTeal mt-10 pt-4 text-sm text-center">
        <p>&copy; {new Date().getFullYear()} Caroline Cleaning Service. All rights reserved.</p>
      </div>
    </footer>
  );
};
