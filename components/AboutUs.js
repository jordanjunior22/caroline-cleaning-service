      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        >
          <div className="p-6 bg-primary rounded-lg shadow-md mb-6">
            <h2 className="text-4xl font-bold text-white mb-4">About Caroline Cleaning Service</h2>
            <p className="text-lg text-white mb-4">
              At Caroline Cleaning Service, we believe that a clean space is a happy space. Our journey began with a passion for cleanliness and a commitment to enhancing the lives of our clients.
            </p>
          </div>
          ...
          >
            Choosing Caroline Cleaning Service means a partner who cares about your needs. Our customized services fit your schedule and requirements.
          </motion.p>
        </motion.div>
