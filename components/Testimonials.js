...
const Testimonials = () => {
  const testimonials = [
    {
      name: "Sarah Johnson",
      feedback: "Caroline Cleaning Service transformed my home! Their attention to detail is unmatched.",
      location: "Los Angeles, CA",
    },
    {
      name: "Mark Thompson",
      feedback: "I can’t believe how clean my office is now. Highly recommend Caroline Cleaning Service!",
